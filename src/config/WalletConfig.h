...
namespace WalletConfig
{
    ...
    const std::string addressPrefix = "KO";

    /* Your coins 'Ticker', e.g. Monero = XMR, Bitcoin = BTC */
    const std::string ticker = "KO";
    ...
    const std::string daemonName = "KnockoutCoind";

    /* The name to call this wallet */
    const std::string walletName = "kowallet";

    /* The name of service/walletd, the programmatic rpc interface to a
       wallet */
    const std::string walletdName = "knockout-service";
